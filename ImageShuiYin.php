...
Class ImageShuiYin{
	...
	//基本参数设置
	//============================================================
	public $src_image_name = ""; //输入图片的文件名(必须包含路径名)
	public $jpeg_quality = 100; //jpeg图片质量
	public $save_file = ''; //输出文件名
	
	//============================================================
	//图片水印设置
	//============================================================
	public $wm_image_name = ""; //水印图片的文件名(必须包含路径名)
	public $wm_image_pos = 3; //水印图片放置的位置
	// 0 = middle
	// 1 = top left
	// 2 = top right
	// 3 = bottom right
	...
	// 8 = middle left
	//other = 3
	public $wm_image_transition = 100; //水印图片与原图片的融合度 (1=100)
	//============================================================
	//文字水印设置
	//============================================================
	public $wm_text = ""; //水印文字(支持中英文以及带有\r\n的跨行文字)
	public $wm_text_size = 20; //水印文字大小
	public $wm_text_angle = 0; //水印文字角度,这个值尽量不要更改
	public $wm_text_pos = 3; //水印文字放置位置
	public $wm_text_font = "./public/shuiyin/chinese.ttf"; //水印文字的字体
	public $wm_text_color = "#000000"; //水印字体的颜色值
	public $wm_text_shadowcolor = "#eeeeee"; //水印字体的颜色值
	//============================================================
	//水印偏距设置
	//============================================================	
	public $wm_offset_x = 0; //x向偏距
	public $wm_offset_y = 0; //y向偏距
	//============================================================
	//原图片最小多少才打上水印
	//============================================================	
	public $src_img_mini_x = 50; //x向最小
	public $src_img_mini_y = 50; //y向最小
