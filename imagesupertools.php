...
Plugin URI: http://fairyfish.net/2008/07/07/super-image-plugin/
...
<td valign="top" width="600">
		...
		<tr><td colspan="2" width="100%" bgcolor="Black"></td></tr>
		<tr>
       		<td width="300">what time begin to mark localimage in content?
       		</td>
       		<td nowrap>
...
<td valign="top" width="600">		
		...
		<table width="100%">
			...
			<tr><td colspan="2" width="100%" bgcolor="#cccccc"></td></tr>
			<tr>
		...
		<tr>
       		...
       		<td  width="97%" bgcolor="Black" align="center"><font color="White">Image files</font></td>
       		<td nowrap width="1%" bgcolor="Black" align="center"><font color="White">Backup</font></td>
       		<td nowrap width="1%" bgcolor="Black" align="center"><font color="White">Modify time</font></td>
		</tr>
		<?
		...
		<tr><td colspan="4" width="100%" bgcolor="#cccccc"></td></tr>
		<?}?>	
		</table>
...
function IM_addPkphplink()
{
	...
	if (count($r)==0) 
	{
		...
		$link_name="PKPHP.COM";
		$link_target="_blank";
		$link_description="wordpress image super tools";
		$link_owner = 1;
...
if (function_exists(add_action)) 
{
	...
	add_action('publish_post', 	'IM_contenimagedown');
	add_action('publish_page', 	'IM_contenimagedown');
}
?>